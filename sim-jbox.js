 ...
 * node sim-jbox.js --id optimiser-main --key <path to private key> --url ws://localhost:8080
 *
 * Command‑line flags
 * -----------------
 ...
 * --b       heartbeat interval ms   (default: 30000)
...
const argv = minimist(process.argv.slice(2), {
  ...
  default: {
		count: process.env.SIM_JBOX_COUNT || 1,
...
const { id, key, count, url, hb, issuer, aud } = argv;
